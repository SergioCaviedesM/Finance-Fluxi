                        ...
                        {cohortCurvesData.data.length > 0 ? (
                            <ResponsiveContainer width="100%" height="100%">
                                <LineChart data={cohortCurvesData.data} margin={{ top: 5, right: 30, left: 0, bottom: 5 }}>
                                    ...
                                    <Tooltip contentStyle={{ backgroundColor: '#1F2937', border: 'none', borderRadius: '8px', color: 'white', fontSize: '12px' }} formatter={(val: number | undefined, name: string) => [`${(val ?? 0).toFixed(1)}%`, formatMonth(name)]} />
